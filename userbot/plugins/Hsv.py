...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**- تم اضافه تغيرات الى السورس بوتسطه ريك @HvvHH**"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "**-  تم تحديث سورس ريك بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond(f"⌔ : لتحديث سورس ريك ارسل : `.تحديث الان` ")
