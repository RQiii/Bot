...
@rekhso.on(admin_cmd(pattern=r"المحظورين?(.*)"))
...
@rekhso.on(admin_cmd(pattern="تشفير الملف ?(.*)"))
async def pyZip(e):
    if e.fwd_from:
        return
    ...
    zip_ = f"{nem_}.zip" if nem_ else "rekhso_Zip.zip"
    password = pass_ if pass_ else "rekhso"
    ...
    try:
        ...
        os.remove(zip_)
        os.remove(dl_)
@rekhso.on(admin_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern=r"المشرفين(?: |$)(.*)"))
async def _(event):
...
@rekhso.on(admin_cmd(pattern=r"البوتات?(.*)"))
async def _(event):
...
@rekhso.on(admin_cmd(pattern=r"الأعضاء(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern=r"معلومات(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern=f"{addition} ?(.*)"))
async def iq(event):
    ...
    rekhso = await get_chatinfo(event)
    ...
    async for user in event.client.iter_participants(rekhso.full_chat.id):
        try:
...
@rekhso.on(admin_cmd(pattern=f"{TFLASH}(.*)"))
async def _(event):
    ...
    rekhsoevent = await edit_or_reply(event, "**🇮🇶 ⦙  جاري تفليش مجموعتك أنتظر قليلآ 🚮**")
    ...
    async for user in event.client.iter_participants(event.chat_id):
        ...
        try:
            ...
            LOGS.info(str(e))
    await rekhsoevent.edit(f"**🇮🇶 ⦙   تم بنجاح تفليش مجموعتك من {total} الاعضاء 🚮**")
    
async def ban_user(chat_id, i, rights):
    try:
        await rekhso(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
    except Exception as exc:
        return False, str(exc)


@rekhso.on(admin_cmd(pattern=f"{LEFT}(.*)"))
async def kickme(leave):
    await leave.edit("**🇮🇶 ⦙   جـاري مـغادرة المجـموعة مـع السـلامة  🚶‍♂️  ..**")
    await leave.client.kick_participant(leave.chat_id, "me")

@rekhso.on(admin_cmd(pattern=f"{REMOVEBAN}(.*)"))
async def _(event):
...
@rekhso.on(admin_cmd(pattern=f"المحذوفين ?([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern=r"احصائيات الاعضاء ?([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern="تقيد(?:\s|$)([\s\S]*)",))
...
@rekhso.iq_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
async def tmuter(event):  # sourcery no-metrics
    ...
    if not user:
        return
    if not reason:
        return await catevent.edit("**🇮🇶 ⦙ رجاء طريقه كتابه الامر خاطئه قم بروئيه قناه شروحات الاوامر : @pmmvn**")
...
@rekhso.on(admin_cmd(pattern=r"احظر(?:\s|$)([\s\S]*)",))
...
@rekhso.on(admin_cmd(pattern=r"حظر عام(?:\s|$)([\s\S]*)",))
...
@rekhso.on(admin_cmd(pattern=r"الغاء حظر العام(?:\s|$)([\s\S]*)",))
...
@rekhso.on(admin_cmd(pattern=r"المحظورين عام$",))
async def gablist(event):
    gbanned_users = gban_sql.get_all_gbanned()
    GBANNED_LIST = "Current Gbanned Users\n"
    if len(gbanned_users) > 0:
...
@rekhso.on(admin_cmd(pattern=r"معلومات تخزين المجموعه(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    input_str = event.pattern_match.group(1)
...
@rekhso.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@rekhso.iq_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@rekhso.on(admin_cmd(pattern=r"تخزين الخاص (تشغيل|ايقاف)$"))
...
@rekhso.on(admin_cmd(pattern=r"تخزين الكروبات (تشغيل|ايقاف)$"))
...
@rekhso.on(admin_cmd(pattern=f"{LINKK} ?(.*)"))
async def iq(SLQ):
...
@rekhso.on(admin_cmd(pattern="عدد رسائلي ?(.*)"))
async def iq(SLQ):
...
@rekhso.on(admin_cmd(pattern="تغير صورة( المجموعة| -d)$"))
...
@rekhso.on(admin_cmd(pattern=f"{ADMINRAISE}(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern=f"{UNADMINRAISE}(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern="تثبيت(?: |$)(.*)"))
async def pin(event):
    "🇮🇶 ⦙   تثبيت  📌"
...
@rekhso.on(admin_cmd(pattern="الغاء التثبيت(?: |$)(.*)"))
async def pin(event):
...
@rekhso.on(admin_cmd(pattern="جلب الاحداث(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern=f"{BANDD}(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern=r"zip(?:\s|$)([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern=r"unzip(?:\s|$)([\s\S]*)"))
...
@rekhso.on(admin_cmd(pattern="معرفه(?: |$)(.*)"))
...
@rekhso.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@rekhso.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@rekhso.on(admin_cmd(pattern=f"{UNBANDD}(?: |$)(.*)"))
...
async def watcher(event):
    if is_muted(event.sender_id, event.chat_id):
        try:
            ...
            LOGS.info(str(e))
@rekhso.on(admin_cmd(pattern="صنع (مجموعه|قناه) (.*)"))
async def iq(event):
...
@rekhso.on(admin_cmd(pattern="تلقائي ?(.*)"))
async def _(event):
...
@rekhso.on(admin_cmd(pattern="الغاء_التلقائي ?(.*)"))
async def _(event):
    if (event.is_private or event.is_group):
        return await edit_or_reply(event, "امر التلقائي يستخدم فقط للقنوات.")
    hel_ = event.pattern_match.group(1)
...
@rekhso.on(admin_cmd(pattern=r"جلب الصور(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()
@rekhso.on(admin_cmd(pattern="تفعيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
...
@rekhso.on(admin_cmd(pattern="تعطيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
    peer_id = event.chat_id
    if not event.is_group:
...
@rekhso.on(admin_cmd(pattern="صلاحيات المجموعه$"))    
async def _(event):  
    res = ""
